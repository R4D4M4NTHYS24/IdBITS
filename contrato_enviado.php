...
<body class="grey lighten-4" >
    ...
    <?php include 'php/my_contacts.php'; ?>
     ...
     <?php include 'php/dataemployee_home.php'; ?>
    ...
    <?php include 'create_new_contract.php'; ?>
      ...
      <header>
        ...
        <?php $receptor_e = $_REQUEST["receptor_e"]; echo $receptor_e?>
        
        <?php $oficio_e = $_POST["oficio_e"]; ?>
        <?php $salario_e = $_POST["salario_e"]; ?>
        <?php $periodo_e = $_POST["periodo_e"]; ?>
        <?php $inicio_e = $_POST["inicio_e"]; ?>
      ...
      <main >  
       ...
       <!-- in this section is the main content -->
            ...
            <!-- main container -->     
              ...
              <div class="row">   
                  <div class="col s12">
                    <div id="doc_enviados"  style="Display:block" class="card">
                      ...
                      <p><span style="font-size: 10.5pt; line-height: 110%; color: black;"><?php echo $receptor_e;?></span></p>
                      </td>
                      </tr>
                      <tr style="height: 17.0pt;">
                      <td style="width: 293.625px; border-right: 1pt solid black; border-bottom: 1pt solid black; border-left: 1pt solid black; border-image: initial; border-top: none; padding: 0cm 5.4pt; height: 17px;" colspan="2">
                      ...
                      <p id="pubkey_sess"><?php echo $PBK;?></p>
                      </td>
                    ...
                    <div id="doc_recibidos"  style="Display:none" class="card">
                      <p style="text-align: justify;"><span style="font-size: 10.5pt; line-height: 110%; font-family: 'Century Gothic',sans-serif;">&nbsp;</span></p>
                      <table style="height: 1385px; border-collapse: collapse; border: none; width: 578px; margin-left: auto; margin-right: auto;" width="578">
                      <tbody>
                      <tr style="height: 23.0pt;">
                      ...
                      <td style="width: 289.625px; border-top: none; border-left: none; border-bottom: 1pt solid black; border-right: 1pt solid black; padding: 0cm 5.4pt; height: 17px;" colspan="2">
                      <p id="emisor_r"><span style="font-size: 10.5pt; line-height: 110%; color: black;"></span></p>
                      </td>
                      </tr>
                      <tr style="height: 18.0pt;">
                      <td style="width: 293.625px; border-right: 1pt solid black; border-bottom: 1pt solid black; border-left: 1pt solid black; border-image: initial; border-top: none; padding: 0cm 5.4pt; height: 18px;" colspan="2">
                      ...
                      <div class="center col l4">                               
                        <button class="btn waves-effect waves-light" onclick="enviar_firmar()">Firmar y Enviar</button>
                      </div>
                    </div>
                 </div>
              </div>
              <div class="row">
                <form name="contraparte" method="POST">
                  <input type="text" name="select-employee" id="select-employee">
                  <input type="submit" id="click_contra">
                </form>
              </div>
...
<script>
 ...
 var current_page = "Mis Contratos Enviados";
