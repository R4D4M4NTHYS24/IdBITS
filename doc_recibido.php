...
<body class="grey lighten-4" onload="makeCode(), leer_contrato()">
    ...
    <?php include 'php/my_contacts.php'; ?>
     ...
     <?php include 'php/dataemployee_recibido.php'; ?>
    <!-- creates a new contract modal --> 
    <?php include 'create_new_contract.php'; ?>
    <!-- creates a new contract modal --> 
    <?php include './php/firmar_recibido.php'; ?>
            ...
            <!-- main container -->     
              ...
              <div id="doc_recibidos">
                <div class="card">
                    ...
                    <p style="text-align: left;" id="ID"><?php echo $ID_r;?></p>
                    </td>
                    </tr>
                    ...
                    <p id="emisor_r"><span style="font-size: 10.5pt; line-height: 110%; color: black;"><?php echo $firmante_r;?></span></p>
                    </td>
                    </tr>
                    ...
                    <td style="width: 289.625px; border-top: none; border-left: none; border-bottom: 1pt solid black; border-right: 1pt solid black; padding: 0cm 5.4pt; height: 17px;" colspan="2">
                    <p><span style="font-size: 10.5pt; line-height: 110%; color: black;"><?php echo $IDENT_emp;?></span></p>
                    </td>
                    </tr>
                    ...
                    <p id="receptor_r"><span style="font-size: 10.5pt; line-height: 110%; color: black;"><?php echo $NAME;?></span></p>
                    </td>
                    </tr>
                    <tr style="height: 17.0pt;">
                    <td style="width: 293.625px; border-right: 1pt solid black; border-bottom: 1pt solid black; border-left: 1pt solid black; border-image: initial; border-top: none; padding: 0cm 5.4pt; height: 17px;" colspan="2">
                    ...
                    <td style="width: 289.625px; border-top: none; border-left: none; border-bottom: 1pt solid black; border-right: 1pt solid black; padding: 0cm 5.4pt; height: 17px;" colspan="2">
                    <p><span style="font-size: 10.5pt; line-height: 110%;"><?php echo $IDENT;?></span></p>
                    </td>
                    </tr>
                    ...
                    <p><span style="font-size: 10.5pt; line-height: 110%;"><?php echo $DATE;?></span></p>
                    </td>
                    </tr>
                    <tr style="height: 17.0pt;">
                    <td style="width: 598.625px; border-right: 1pt solid black; border-bottom: 1pt solid black; border-left: 1pt solid black; border-image: initial; border-top: none; background: black; padding: 0cm 5.4pt; height: 17px;" colspan="4">
                    ...
                    <p style="text-align: center; tab-stops: -7.1pt 0cm; border: none; margin: 3.0pt 0cm 3.0pt 0cm;"><strong><span style="font-size: 10.5pt; line-height: 110%; color: white;">EL TRABAJADOR (Pre-Visualización)</span></strong></p>
                    </td>
                    </tr>
                    <tr>
                    ...
                    <img style="height: 140px; width: 115px; margin: auto;" src="firmas/<?php echo $IDENT_emp;?>">
                    </td>
                    ...
                    <td style="width: 112.25pt; border-top: none; border-left: none; border-bottom: solid black 1.0pt; border-right: solid black 1.0pt; padding: 0cm 5.4pt 0cm 5.4pt;" width="150">
                    <p style="text-align: center; tab-stops: -7.1pt 0cm; border: none; margin: 3.0pt 0cm 3.0pt 0cm;"><strong><span style="font-size: 10.5pt; line-height: 110%; color: #7f7f7f;">C&oacute;digo Qr</span></strong></p>
                    <div id="qrcode_r" style="width:100px; height:100px; margin-top:15px;"></div>
                    </td>
                    </tr>
                    <tr>
                    <td style="width: 224.45pt; border: solid black 1.0pt; border-top: none; padding: 0cm 5.4pt 0cm 5.4pt;" colspan="2" width="299">
                      <p><strong><span style="font-size: 10.5pt; line-height: 110%; color: black;"><?php echo $firmante_r;?></span></strong></p>
                      <p><span style="font-size: 10.5pt; line-height: 110%; color: black;">C.C. <?php echo $IDENT_emp;?></span></p>
                      <p><span style="font-size: 10.5pt; line-height: 110%; color: black;"><?php echo $MAIL_emp;?></span></p>
                      <p><span style="font-size: 10.5pt; line-height: 110%; color: black;"><?php echo $COMPANY_emp;?></span></p>
                      <p><strong><span style="font-size: 10.5pt; line-height: 110%; color: black;"><?php echo $ADDRESS_emp;?></span></strong></p>
                      <p><span style="font-size: 10.5pt; line-height: 110%; color: black;">Clave Publica:</span></p>
                      <p id="owner_e"><?php echo $PBK_emp;?></p>
                    </td>
                    <td style="width: 224.45pt; border-top: none; border-left: none; border-bottom: solid black 1.0pt; border-right: solid black 1.0pt; padding: 0cm 5.4pt 0cm 5.4pt;" colspan="2" width="299">
                      <p><strong><span style="font-size: 10.5pt; line-height: 110%; font-style: italic; color: #a9a9a9;"><?php echo $NAME;?></span></strong></p>
                      <p><span style="font-size: 10.5pt; line-height: 110%; font-style: italic; color: #a9a9a9;">C.C. <?php echo $IDENT;?></span></p>
                      <p><span style="font-size: 10.5pt; line-height: 110%; font-style: italic; color: #a9a9a9;"><?php echo $MAIL;?></span></p>
                      <p><span style="font-size: 10.5pt; line-height: 110%; font-style: italic; color: #a9a9a9;"><?php echo $COMPANY;?></span></p>
                      <p><strong><span style="font-size: 10.5pt; line-height: 110%; font-style: italic; color: #a9a9a9;"><?php echo $ADDRESS;?></span></strong></p>
                      <p><span style="font-size: 10.5pt; line-height: 110%; font-style: italic; color: #a9a9a9;">Clave Publica:</span></p>
                      <p id="owner_r" style="font-style: italic; color: #a9a9a9"><?php echo $PBK;?></p>
                      <div class="center col l4">                               
                        <a class="btn waves-effect waves-light modal-trigger" href= "#modal_firmar_recibido">Firmar y Enviar</a>
                        <br>
                    </div>
                    </td>
                    </tr>
 ...
 <script src="JavaScript/firmar_contrato_recibido.js"></script>
