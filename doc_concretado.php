...
<body class="grey lighten-4" onload="makeCode(), leer_contrato()">
    ...
    <?php include 'php/my_contacts.php'; ?>
     ...
     <?php include 'php/dataemployee_concretado.php'; ?>
            ...
            <!-- main container -->     
              ...
              <div id="doc_recibidos">
                <div class="card">
                    ...
                    <p style="text-align: left;" id="ID"><?php echo $ID_c;?></p>
                    </td>
                    </tr>
                    ...
                    <p id="emisor_r"><span style="font-size: 10.5pt; line-height: 110%; color: black;"><?php echo $firmante_c;?></span></p>
                    </td>
                    </tr>
                    ...
                    <td style="width: 224.45pt; border: solid black 1.0pt; border-top: none; padding: 0cm 5.4pt 0cm 5.4pt;" colspan="2" width="299">
                      <p><strong><span style="font-size: 10.5pt; line-height: 110%; color: black;"><?php echo $firmante_c;?></span></strong></p>
                    ...
                    <div class="center col l4">                               
                        <button class="btn waves-effect waves-light" onclick="return xepOnline.Formatter.Format('prueba',{pageWidth:'216mm', pageHeight:'279mm'});">Imprimir</button>
                        <a onclick="return xepOnline.Formatter.Format('prueba',{pageWidth:'216mm', pageHeight:'279mm'});">BUTTON</a>
                    </div>
                    </div>
              </div>
