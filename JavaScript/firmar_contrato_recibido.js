function firmar_contrato_recibido(privateKeyUser, publicKeyUser) {
    ID_cont=document.getElementById("ID").innerHTML;
...
function emision(privateKeyUser, publicKeyUser) {
    web3.eth.getTransactionCount(publicKeyUser, (err, txCount) => {
        ...
        const data = contract.methods.firmar_contrato(ID_cont).encodeABI();
