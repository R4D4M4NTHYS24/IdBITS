...
<body class="grey lighten-4" onload="makeCode(), leer_contrato()">
    ...
    <!-- php file to show datauser  -->
    <?php include 'php/dataemployee_enviado.php'; ?>
    <!-- php file to sesion start --> 
              ...
              <nav class="transparent" >
                <div class="nav-wrapper">
                  <div class="col s12">
                    ...
                    <a href="#!" class="breadcrumb">Contratos Pendientes</a>
                  </div>
                </div>
              </nav>
            <!-- breadcrumb ends -->
            ...
            <!-- main container -->     
               ...
               <div class="masonry-row" style="position:relative;">
                ...
                <div class="row">   
                   <div class="col s12 m4 l4">   
                          ...
                          <div class="card hoverable">
                            <div class="card-content">
                              <span class="card-title"><b>Enviados</b></span>
                              <a class="red-text" href="Pendientes.php"> 3 Contratos Enviados</a>
                            </div>
                   ...
                   <div class="col s12 m4 l4">   
                          ...
                          <div class="card hoverable">
                            <div class="card-content ">
                              <span class="card-title"><b>Recibidos</b></span>
                              <a class="orange-text" href="ejecucion.php">2 Contratos en Recibidos</a>
                            </div>
                   ...
                   <div class="col s12 m4 l4">   
                      <div class="card hoverable">
                        <div class="card-content">
                          <span class="card-title"><b>Concretados</b></span>
                          <a class="green-text" href="terminados.php">25 Contratos Concretados</a>
                        </div>
              ...
              <div id="doc_enviados">
                <div class="card">
                    ...
                    <p style="text-align: left;" id="ID"><?php echo $ID_e;?></p>
                    </td>
                    </tr>
                    ...
                    <p id="emisor_e"><span style="font-size: 10.5pt; line-height: 110%; color: black;"><?php echo $NAME;?></span></p>
                    </td>
                    </tr>
                    ...
                    <p id="receptor_e"><span style="font-size: 10.5pt; line-height: 110%; color: black;"><?php echo $firmante_e;?></span></p>
                    </td>
                    </tr>
                    <tr style="height: 17.0pt;">
                    <td style="width: 293.625px; border-right: 1pt solid black; border-bottom: 1pt solid black; border-left: 1pt solid black; border-image: initial; border-top: none; padding: 0cm 5.4pt; height: 17px;" colspan="2">
                    ...
                    <p><span style="font-size: 10.5pt; line-height: 110%;"><?php echo $DATE_emp;?></span></p>
                    </td>
                    </tr>
                    <tr style="height: 17.0pt;">
                    <td style="width: 598.625px; border-right: 1pt solid black; border-bottom: 1pt solid black; border-left: 1pt solid black; border-image: initial; border-top: none; background: black; padding: 0cm 5.4pt; height: 17px;" colspan="4">
                    ...
                    <tr style="height: 17.0pt;">
                    <td style="width: 293.625px; border-right: 1pt solid black; border-bottom: 1pt solid black; border-left: 1pt solid black; border-image: initial; border-top: none; background: white; padding: 0cm 5.4pt; height: 17px;" colspan="2">
                    <p><strong><span style="font-size: 10.5pt; line-height: 110%; color: black;">Duración</span></strong></p>
                    </td>
                    <td style="width: 289.625px; border-top: none; border-left: none; border-bottom: 1pt solid black; border-right: 1pt solid black; background: white; padding: 0cm 5.4pt; height: 17px;" colspan="2">
                    <p id="duracion"></p>
                    </td>
                    ...
                    <tr style="height: 16.0pt;">
                    <td style="width: 598.625px; border-right: 1pt solid black; border-bottom: 1pt solid black; border-left: 1pt solid black; border-image: initial; border-top: none; background: white; padding: 0cm 5.4pt; height: 16px;" colspan="4">
                    <p style="line-height: 117%;"><span style="font-size: 10.5pt; line-height: 117%; color:red">Firma de Contraparte Pendiente</span></p>
                    </td>
                    </tr>
                    <tr style="height: 16.0pt;">
                    <td style="width: 598.625px; border-right: 1pt solid black; border-bottom: 1pt solid black; border-left: 1pt solid black; border-image: initial; border-top: none; background: black; padding: 0cm 5.4pt; height: 16px;" colspan="4">
                    ...
                    <p style="text-align: center; tab-stops: -7.1pt 0cm; border: none; margin: 3.0pt 0cm 3.0pt 0cm;"><strong><span style="font-size: 10.5pt; line-height: 110%; color: yellow;">EL TRABAJADOR (Firma Pendiente)</span></strong></p>
                    </td>
                    </tr>
                    <tr>
                    ...
                    <div id="qrcode_e" style="width:100px; height:100px; margin-top:15px;"></div>
                    </td>
                    <td style="width: 112.2pt; border-top: none; border-left: none; border-bottom: solid black 1.0pt; border-right: solid black 1.0pt; padding: 0cm 5.4pt 0cm 5.4pt;background: #ffff99; position: relative;" width="150">
                    <p style="text-align: center; tab-stops: -7.1pt 0cm; border: none; margin: 3.0pt 0cm 3.0pt 0cm;"><strong><span style="font-size: 10.5pt; line-height: 110%; color: #7f7f7f;">Firma escaneada</span></strong></p>
                    <img style="height: 140px; width: 115px; margin: auto; -webkit-filter: grayscale(100%); filter: grayscale(100%); opacity: 0.5;" src="firmas/<?php echo $IDENT_emp;?>">
                    </td>
                    <td style="width: 112.25pt; border-top: none; border-left: none; border-bottom: solid black 1.0pt; border-right: solid black 1.0pt; padding: 0cm 5.4pt 0cm 5.4pt; background: #ffff99; position: relative;" width="150">
                    <p style="text-align: center; tab-stops: -7.1pt 0cm; border: none; margin: 3.0pt 0cm 3.0pt 0cm;"><strong><span style="font-size: 10.5pt; line-height: 110%; color: #7f7f7f;">C&oacute;digo Qr</span></strong></p>
                    <div id="qrcode_r" style="width:100px; height:100px; margin-top:15px; -webkit-filter: grayscale(100%); filter: grayscale(100%); opacity: 0.5;"></div>
                    </td>
                    </tr>
                    <tr>
                    ...
                    <p id="owner_e"><?php echo $PBK;?></p>
                    </td>
                    <td style="width: 224.45pt; border-top: none; border-left: none; border-bottom: solid black 1.0pt; border-right: solid black 1.0pt; padding: 0cm 5.4pt 0cm 5.4pt; background: #ffff99; position: relative;" colspan="2" width="299">
                      <p><strong><span style="font-size: 10.5pt; line-height: 110%; font-style: italic; color: #a9a9a9;"><?php echo $firmante_e;?></span></strong></p>
                      <p><span style="font-size: 10.5pt; line-height: 110%; font-style: italic; color: #a9a9a9;">C.C. <?php echo $IDENT_emp;?></span></p>
                      <p><span style="font-size: 10.5pt; line-height: 110%; font-style: italic; color: #a9a9a9;"><?php echo $MAIL_emp;?></span></p>
                      <p><span style="font-size: 10.5pt; line-height: 110%; font-style: italic; color: #a9a9a9;"><?php echo $COMPANY_emp;?></span></p>
                      <p><strong><span style="font-size: 10.5pt; line-height: 110%; font-style: italic; color: #a9a9a9;"><?php echo $ADDRESS_emp;?></span></strong></p>
                      <p><span style="font-size: 10.5pt; line-height: 110%; font-style: italic; color: #a9a9a9;">Clave Publica:</span></p>
                      <p id="owner_r" style="font-size: 10.5pt; line-height: 110%; font-style: italic; color: #a9a9a9;"><?php echo $PBK_emp;?></p>
                    </td>
                    </tr>
                    <tr>
 ...
 <script src="JavaScript/id_look.js"></script>
 ...
 <!-- this script initializes Dropdown for settings -->
    ...
    <script type="text/javascript" src="./qrcode/qr_contrato.js"></script>
...
<script>
 ...
 var current_page = "Mis Contratos Pendientes";
