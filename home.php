      ...
      <main >  
       ...
       <!-- in this section is the main content -->
            ...
            <!-- breadcrumb starts -->
              <nav class="transparent" >
                <div class="nav-wrapper">
                  <div class="col s12">
                    <a href="#!" class="breadcrumb">Solemne</a>
            ...
            <!-- main container -->     
                ...
                <div class="row">   
                  ...
                  <div class="card">
                    ...
                    <div class="card">
                      ...
                      <button type="button" class="btn btn-primary btn-lg btn-block" onclick="consultar_contratos_enviados()">Verificar Enviados</button>
                      <button type="button" class="btn btn-primary btn-lg btn-block" onclick="consultar_contratos_recibidos()">Verificar Recibidos</button>
                    </div>
                    <div class="card-tabs">
                      <ul class="tabs tabs-fixed-width">
                        <li class="tab"><a href="#test4">Enviados</a></li>
                        <li class="tab"><a class="active" href="#test5">Recibidos</a></li>
                        <li class="tab"><a href="#test6">Concretados</a></li>
                      </ul>
                    </div>
              ...
              <div class="row">   
                  <div class="col s12">
                    <div id="prueba"  style="Display:none" class="card">
