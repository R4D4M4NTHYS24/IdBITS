                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="mx-auto d-block">
                                            ...
                                            <h5 class="text-sm-center mt-2 mb-1">Crear un modelo de monetizacion por fee para DAPP</h5>
                                        </div>
                                        <hr>
                                        <div class="card-text text-sm-center">
